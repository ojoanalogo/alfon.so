...
export const TRASH_JUNK: TrashJunkItem[] = [
  ...
  { id: 'node_modules', name: 'node_modules', kind: 'Carpeta', iconSrc: folder, isFolder: true, size: '1 PB' },
  ...
  { id: 'zip', name: 'backup_backup.zip', kind: 'Carpeta comprimida', iconSrc: folder, isFolder: true },
