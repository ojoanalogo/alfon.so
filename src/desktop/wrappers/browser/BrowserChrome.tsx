...
export default function BrowserChrome({
  ...
  return (
    <div className="flex w-full min-w-0 flex-1 items-center gap-[0.375rem] leading-none">
      ...
      <div
        className="flex h-[1.125rem] min-w-0 flex-1 items-center gap-1 border border-[color:var(--color-hairline)] bg-[var(--color-control-fill)] px-[0.3125rem] py-0 font-[ui-monospace,monospace] text-[0.6875rem] leading-none max-sm:h-6"
        onPointerDown={(event) => event.stopPropagation()}
      >
