  ...
  return (
    ...
    >
      {colorId === 'default' ? (
        ...
        <span className="settings-color-swatch__fill" style={{ backgroundColor: value }} aria-hidden="true" />
      )}
    </button>
  );
}
  ...
  return (
    <div className="settings-panel">
      <section className="settings-block" aria-labelledby="settings-appearance-heading">
        <h3 id="settings-appearance-heading" className="settings-block__title">
          Apariencia
        </h3>
      ...
      <section className="settings-block" aria-labelledby="settings-fill-heading">
        <h3 id="settings-fill-heading" className="settings-block__title">
          Color de relleno
        </h3>
        <div className="settings-group">
      ...
      <section className="settings-block" aria-labelledby="settings-images-heading">
        <h3 id="settings-images-heading" className="settings-block__title">
          Imágenes
        </h3>
        {wallpapers.length === 0 ? (
              ...
              {wallpapers.map((wallpaper) => {
                ...
                return (
                  <li key={wallpaper.id}>
                    <button
                      type="button"
                      className={['settings-wallpaper', selected && 'is-selected'].filter(Boolean).join(' ')}
                      aria-pressed={selected}
